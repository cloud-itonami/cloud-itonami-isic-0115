...
operation, finalizing a curing-barn temperature decision, finalizing a
pesticide-application decision, and any non-`:propose` effect are
permanently blocked; `:high`/`:safety-critical` actions (crop-health/
curing-defect/pest concerns, high-cost supply orders) require human
sign-off.
