# Operator Quickstart — Tobacco-Growing Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0115** (`cloud-itonami-isic-0115`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0115.git
cd cloud-itonami-isic-0115
```
...
- Blueprint governor key: `tobacco-operations-governor`
- Likely source path: `tobaccoops.governor.cljc`
